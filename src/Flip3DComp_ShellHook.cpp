...
HRESULT Flip3DComp::CreateCardVisual(CardModel& card)
{
    ...
    container->SetBitmapInterpolationMode(DCOMPOSITION_BITMAP_INTERPOLATION_MODE_NEAREST_NEIGHBOR);

    card.m_visual->SetBorderMode(DCOMPOSITION_BORDER_MODE_SOFT);
    card.m_visual->SetBitmapInterpolationMode(DCOMPOSITION_BITMAP_INTERPOLATION_MODE_NEAREST_NEIGHBOR);
