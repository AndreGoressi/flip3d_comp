...
void Flip3DComp::SelectWindow(HWND hwndTarget)
{
    ...
    {
        auto v0 = ShowWindowAsync(hwndTarget, SW_SHOWNOACTIVATE);
        v0 = SendMessageW(hwndTarget, WM_SYSCOMMAND, SC_RESTORE, 0);
        //
        UpdateCardGeometry(m_cards[(size_t)selIdx], m_monW, m_monH, /*selectedRestore=*/v0);
    }
